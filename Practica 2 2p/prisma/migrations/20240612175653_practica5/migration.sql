...
CREATE TABLE "Inscripcion" (
    ...
    "estado" TEXT NOT NULL DEFAULT 'Activo',
    CONSTRAINT "Inscripcion_id_aspirante_fkey" FOREIGN KEY ("id_aspirante") REFERENCES "Anspirante" ("id") ON DELETE RESTRICT ON UPDATE CASCADE,
